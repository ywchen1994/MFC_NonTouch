...
BEGIN_MESSAGE_MAP(CMFC_NonTouchApp, CWinApp)
...
CMFC_NonTouchApp::CMFC_NonTouchApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_NonTouchApp 物件

CMFC_NonTouchApp theApp;


// CMFC_NonTouchApp 初始設定

BOOL CMFC_NonTouchApp::InitInstance()
{
